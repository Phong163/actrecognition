...
# Load YOLO model
yolo_weights = r"C:\Users\OS\Desktop\ActionProject\weights\yolov5s.onnx"
...
lstm_model_path = "model_lstm_multiclass.onnx"
...
def act_recognize():
    ...
    track_keypoints[track_id].clear()
...
if __name__ == "__main__":  
    ...
    video = r"C:\Users\OS\Desktop\ActionProject\videos\IMG_5614.MOV"
    ...
    while cap.isOpened():
        ...
        if tracks:
            for track in tracks:
                ...
                if len(track_keypoints[track_id]) == 6:
